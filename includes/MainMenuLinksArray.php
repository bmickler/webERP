 ...
 */
/**
 * Set available applications/modules
 */
$ModuleLink = array('Sales', 'AR', 'PO', 'AP', 'stock', 'manuf', 'GL', 'FA', 'PC', 'system', 'Utilities');

$ReportList = array('Sales' => 'ord', 'AR' => 'ar', 'PO' => 'prch', 'AP' => 'ap', 
    'stock' => 'inv', 'manuf' => 'man', 'GL' => 'gl', 'FA' => 'fa', 'PC' => 'pc', 
    'system' => 'sys', 'Utilities' => 'utils');

/**
 * The headings showing on the tabs accross the main index used also in WWW_Users 
 * for defining what should be visible to the user
 */
$ModuleList = array(_('Sales'), _('Receivables'), _('Purchases'), _('Payables'),
    _('Inventory'), _('Manufacturing'), _('General Ledger'), _('Asset Manager'),
    _('Petty Cash'), _('Setup'), _('Utilities'));

/**
 * Begin module menu definitions
 * 
 * Menus have two components controlling their 
 * configuration, a caption and a URL.  Each menu item, belongs to a section 
 * (transactions, reports, maintenance, etc..), which each belong to an 
 * application/module.  When adding/editing a menu item, the menu's configuration.
 */
 ...
 */
    ...
    $MenuItems['Sales']['Maintenance']['Caption'] = array(
        _('Create Contract'), _('Select Contract'), _('Sell Through Support Deals'));

    $MenuItems['Sales']['Maintenance']['URL'] = array(
        '/Contracts.php', '/SelectContract.php', '/SellThroughSupport.php');
 ...
 */
    ...
    $MenuItems['AR']['Maintenance']['Caption'] = array(_('Add Customer'), _('Select Customer'));
 ...
 */
    $MenuItems['AP']['Transactions']['Caption'] = array(_('Select Supplier'), _('Supplier Allocations'));
    ...
    $MenuItems['AP']['Reports']['URL'] = array(
        '/SuppWhereAlloc.php', 
        '/AgedSuppliers.php', 
        '/SuppPaymentRun.php', 
    ...
    $MenuItems['AP']['Maintenance']['Caption'] = array(
        _('Add Supplier'), 
        _('Select Supplier'), 
        _('Maintain Factor Companies'));

    $MenuItems['AP']['Maintenance']['URL'] = array(
        '/Suppliers.php', '/SelectSupplier.php', '/Factors.php');
 ...
 */
    ...
    $MenuItems['PO']['Transactions']['URL'] = array(
 ...
 */
    ...
    $MenuItems['stock']['Reports']['URL'] = array(
    ...
    $MenuItems['stock']['Maintenance']['URL'] = array(
        '/Stocks.php', 
        '/SelectProduct.php', 
 ...
 */
    $MenuItems['manuf']['Transactions']['Caption'] = array(
        _('Work Order Entry'), _('Select A Work Order'), _('QA Samples and Test Results'));

    $MenuItems['manuf']['Transactions']['URL'] = array(
        '/WorkOrderEntry.php', '/SelectWorkOrder.php', '/SelectQASamples.php');

    $MenuItems['manuf']['Reports']['Caption'] = array(
    ...
    $MenuItems['manuf']['Reports']['URL'] = array(
        '/SelectWorkOrder.php', 
        '/BOMInquiry.php', 
    ...
    $MenuItems['manuf']['Maintenance']['URL'] = array(
        '/WorkCentres.php', 
        '/BOMs.php', 
        '/CopyBOM.php', 
        '/MRPDemands.php', 
 ...
 */
    ...
    $MenuItems['GL']['Reports']['URL'] = array(
 ...
 * Fixed Assets module
 */
    $MenuItems['FA']['Transactions']['Caption'] = array(
        _('Add a new Asset'), 
        _('Select an Asset'), 
        _('Change Asset Location'), 
        _('Depreciation Journal'));

    $MenuItems['FA']['Transactions']['URL'] = array(
        '/FixedAssetItems.php', 
        '/SelectAsset.php', 
        '/FixedAssetTransfer.php', 
        '/FixedAssetDepreciation.php');

    $MenuItems['FA']['Reports']['Caption'] = array(
        _('Asset Register'), 
        _('My Maintenance Schedule'), 
        _('Maintenance Reminder Emails'));

    $MenuItems['FA']['Reports']['URL'] = array(
        '/FixedAssetRegister.php', 
        '/MaintenanceUserSchedule.php', 
        '/MaintenanceReminders.php');

    $MenuItems['FA']['Maintenance']['Caption'] = array(
        _('Fixed Asset Category Maintenance'), _('Add or Maintain Asset Locations'), _('Fixed Asset Maintenance Tasks'));

    $MenuItems['FA']['Maintenance']['URL'] = array(
        '/FixedAssetCategories.php', '/FixedAssetLocations.php', '/MaintenanceTasks.php');

/**
 * Petty Cash module
 */
$MenuItems['PC']['Transactions']['Caption'] = array(
    _('Assign Cash to PC Tab'), 
    _('Transfer Assigned Cash Between PC Tabs'), 
    _('Claim Expenses From PC Tab'), 
    _('Authorise Expenses'), 
    _('Authorise Assigned Cash'));
...
$MenuItems['PC']['Reports']['Caption'] = array(
    _('PC Tab General Report'), 
    _('PC Expense General Report'), 
    _('PC Tab Expenses List'), 
    _('PC Expenses Analysis'));

$MenuItems['PC']['Reports']['URL'] = array(
    '/PcReportTab.php', 
    '/PcReportExpense.php', 
    '/PcTabExpensesList.php', 
    '/PcAnalysis.php');

$MenuItems['PC']['Maintenance']['Caption'] = array(
    _('Types of PC Tabs'), 
    _('PC Tabs'), 
    _('PC Expenses'), 
    _('Expenses for Type of PC Tab'));

$MenuItems['PC']['Maintenance']['URL'] = array(
    '/PcTypeTabs.php', 
    '/PcTabs.php', 
    '/PcExpenses.php', 
...
/**
 * System Core configuration module
 */
    ...
    $MenuItems['system']['Reports']['URL'] = array(
        ...
        '/CustomerTypes.php', 
        '/SupplierTypes.php', 
        '/CreditStatus.php', '/PaymentTerms.php', '/PO_AuthorisationLevels.php', '/PaymentMethods.php', '/SalesPeople.php', '/Areas.php', '/Shippers.php', '/SalesGLPostings.php', '/COGSGLPostings.php', '/FreightCosts.php', '/DiscountMatrix.php');

    $MenuItems['system']['Maintenance']['Caption'] = array(
        _('Inventory Categories Maintenance'), 
 ...
 */
    ...
    $MenuItems['Utilities']['Transactions']['URL'] = array(
