 ...
 * $Title should be defined in the calling page before this file is included
 * 
 * @package webERP
 * @subpackage Core
...
if(isset($Title) && $Title == _('Copy a BOM to New Item Code')){
    /**
     * solve the cannot modify header information in CopyBOM.php scripts
     */
    ob_start();
}
...
/**
 * If it is set the $_SESSION['ShowPageHelp'] parameter AND it is FALSE, hides 
 * the page help text:
 */
